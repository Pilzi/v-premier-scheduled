...
public class PathUtil {
    ...
    private static final String PREMIERE_PATH = "/premier";
    ...
    public static URI getSeasons(@NonNull String region) {
        return URI.create(String.join("", API_URL, VALORANT_PATH, API_VERSION_V1, PREMIERE_PATH, SEASONS_PATH, PATH_SEPARATOR, region));
    }
}
